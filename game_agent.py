...
def custom_score(game, player):
    ...
    p1_left_moves = len(game.get_legal_moves(player))
    p2_left_moves = len(game.get_legal_moves(game.get_opponent(player)))

    return float(2 * p1_left_moves - p2_left_moves)
...
def custom_score_2(game, player):
    ...
    return float(p1_left_moves - 2 * p2_left_moves)
